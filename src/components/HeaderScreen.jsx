          ...
          <div className="flex items-center justify-between gap-3">
              ...
              <div className="relative shrink-0">
                ...
                <div
                  className={`absolute bottom-0 right-0 w-4 h-4 rounded-full border-2 border-[#0b0f19] ${
                    hasUser ? "bg-green-400" : "bg-red-500"
                  }`}
                ></div>
              </div>
            ...
            <div
              className={`flex items-center gap-2 rounded-full px-4 py-2 border shrink-0 ${
                hasUser ? "bg-emerald-500/10 border-emerald-500/20" : "bg-red-500/10 border-red-500/20"
              }`}
            >
              <span
                className={`w-2.5 h-2.5 rounded-full animate-pulse ${
                  hasUser ? "bg-emerald-400" : "bg-red-400"
                }`}
              ></span>

              <span
                className={`text-xs font-medium ${
                  hasUser ? "text-emerald-300" : "text-red-300"
                }`}
              >
                {hasUser ? "Live" : "Error"}
              </span>
